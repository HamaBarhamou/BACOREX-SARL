...
urlpatterns = [
    ...
    path(
        "projet/<int:project_id>/add-agent/<int:user_id>/",
        views.add_agent,
        name="add_agent",
    ),
    path(
        "projet/<int:project_id>/remove-agent/<int:user_id>/",
        views.remove_agent,
        name="remove_agent",
    ),
    ...
    path(
        ...
        views.list_phases_for_project,
        name="list_phases_for_project",
    ),
    path(
        "projects/<int:project_id>/phases/new/",
        views.new_phase_for_project,
        name="new_phase_for_project",
    ),
    path(
        "phases/<int:phase_id>/<int:projet_id>/",
        views.phase_detail,
        name="phase_detail",
    ),
    path(
        "phases/<int:phase_id>/<int:projet_id>/edit/",
        views.edit_phase,
        name="edit_phase",
    ),
    path(
        "phases/<int:phase_id>/<int:projet_id>/delete/",
        views.delete_phase,
        name="delete_phase",
    ),
    ...
    path("projet/<int:projet_id>/achats/", views.liste_achats, name="liste_achats"),
    path(
        "projet/<int:projet_id>/achat/nouveau/", views.nouvel_achat, name="nouvel_achat"
    ),
    path(
        "projet/<int:projet_id>/achat/<int:achat_id>/",
        views.detail_achat,
        name="detail_achat",
    ),
    path(
        "projet/<int:projet_id>/achat/<int:achat_id>/modifier/",
        views.modifier_achat,
        name="modifier_achat",
    ),
    path(
